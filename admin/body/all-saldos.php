            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <script type="text/javascript">
                        // window.location.href = window.location.origin+"/admin/invoice.php?invId=40&type=1";
                        ...
                        $("#abono-confirm").click(function() {
                            ...
                            $.ajax({
                                ...
                                setTimeout(function() {
                                    window.location.href = window.location.origin + '/admin/invoice.php?invId=' + msg + '&type=1'; //will redirect to your blog page (an ex: blog.html)
                                }, 1000); //will call the function after 1 secs.
                                // window.location.href = window.location.origin + "/admin/invoice.php?invId=" + msg + "&type=1";
                            });
                        });
