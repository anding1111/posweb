        ...
        <div class="panel panel-default w3-card-4">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-all-credito" width="100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Recibo</th>
                                <th>Cliente</th>
                                <th style="text-align:right">Debía</th>
                            ...
                            ?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td style="text-align:right">
                                        <?php
                                        echo $abonos->saldo + $data->cPayment;
                                        ?>
                                    </td>
                                    <td style="text-align:right">
                                        <?php
                    ...
                    <script type="text/javascript">
                        ...
                        $("#abono-confirm").click(function() {
                            ...
                            $.ajax({
                                ...
                                type: "post",
                                data: {
                                    dIdSupplier: idSupplier,
                                    dSaldo: saldoSupplier
                                }
                            }).done(function(msg) {
