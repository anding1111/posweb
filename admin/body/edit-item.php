...
$qry = mysqli_fetch_object($conexion->query("SELECT * FROM items WHERE pId = '$pId' AND `shId` = " . $_SESSION['shId'] . " AND `idStore` = " . $_SESSION['idStore'] . " "));
...
if (@$_POST['submit']) {
    ...
    $update = "UPDATE items SET pName = '" . $pName . "', pIdBrand = '" . $pIdBrand . "', pBarCode = '" . $pBarCode . "', pQuantity = '" . $pQuantity . "', pCost = '" . $pCost . "', pPrice = '" . $pPrice . "' WHERE pId = '" . $pId . "' AND `shId` = " . $_SESSION['shId'] . " AND `idStore` = " . $_SESSION['idStore'] . " ";
    ...
    //         $update = "UPDATE items SET pBarCode = '".$pBarCode."', pIdBrand = '".$pIdBrand."' WHERE pId = '".$pId."' AND `shId` = ".$_SESSION['shId']." AND `idStore` = ".$_SESSION['idStore']." ";
    //         $qry = $conexion->query($update) or die(mysqli_error($conexion));
    ...
    $update = "UPDATE items SET pQuantity = '" . $pQuantity . "' WHERE pId = '" . $pId . "' AND `shId` = " . $_SESSION['shId'] . " AND `idStore` = " . $_SESSION['idStore'] . " ";
    $qry = $conexion->query($update) or die(mysqli_error($conexion));
    //$qry = mysql_query($update) or die(mysql_error());
