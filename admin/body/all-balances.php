                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-credito-compra" width="100%">
                               ...
                               <?php  
                                   ...
                                   $qry = getTotalAllSaldosSuppliers();                                                                    
                                ...
                                ?>
                                       ...
                                       <tr class="odd gradeX">
                                           ...
                                           ?>
                                                   ...
                                                   <?php 
                                                   echo $data->Total - $data->Abonos;
                                                   ?>
                                                   </td>
                                       
                                                <td style="text-align:center">
                                                    <?php echo '<a href="#agree_modal" class="btn btn-default btn-small" id="custId" data-toggle="modal" data-id="'.$data->suId.'">Abonar</a>';?>
